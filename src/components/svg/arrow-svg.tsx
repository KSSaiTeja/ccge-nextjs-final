  ...
  return (
    ...
    >
      <path
        ...
        stroke="var(--brand-red-600, #e61e24)"
        strokeMiterlimit="10"
      />
      <path
        ...
        strokeMiterlimit="10"
      />
      <rect x="9.5" width="1" height="120" fill="var(--brand-red-600, #e61e24)" />
    </svg>
  );
}
...
export function RightSmArrowThree() {
  return (
    ...
    >
      <path
        d="M1 6H11"
        stroke="var(--brand-blue-600, #2f76b7)"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
export function RightArrowSix({ clr = "var(--brand-blue-600, #2f76b7)" }: { clr?: string }) {
  return (
    <svg
      width="16"
      height="12"
