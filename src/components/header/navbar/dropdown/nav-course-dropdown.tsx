  ...
  return (
    <div className="megamenu-demo-courses p-relative">
      ...
      <div className="tp-megamenu-courses-wrap d-none d-xl-block">
        <h4 className="tp-megamenu-courses-wrap-title">CCGE Excellence</h4>
        <p>Professional certifications for global commerce education</p>
        <div className="tp-megamenu-courses-thumb">
          <Image src={shape} alt="CCGE Education" />
        </div>
      </div>
    </div>
  );
