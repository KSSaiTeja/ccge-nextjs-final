...
export const metadata: Metadata = {
  title: "Investment Banking Operations - CCGE | Corporate Commerce Global Education",
  description: "Master Investment Banking Operations with CCGE's comprehensive program"
};

export default function InvestmentBankingOperationsPage() {
  const course = ccge_courses.find((item) => item.id === 8);
