...
export const metadata: Metadata = {
  title: "EA Course - CCGE | Corporate Commerce Global Education",
  description: "Master EA with CCGE's comprehensive US taxation program"
};

export default function EACoursePage() {
  const course = ccge_courses.find((item) => item.id === 7);
