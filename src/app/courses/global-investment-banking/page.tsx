...
export const metadata: Metadata = {
  title: "Global Investment Banking - CCGE | Corporate Commerce Global Education",
  description: "Master Global Investment Banking with CCGE's comprehensive program"
};

export default function GlobalInvestmentBankingPage() {
  const course = ccge_courses.find((item) => item.id === 9);
