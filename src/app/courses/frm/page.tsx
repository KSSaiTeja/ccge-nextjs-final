...
export const metadata: Metadata = {
  title: "FRM Course - CCGE | Corporate Commerce Global Education",
  description: "Master FRM with CCGE's comprehensive risk management program"
};

export default function FRMCoursePage() {
  const course = ccge_courses.find((item) => item.id === 5);
