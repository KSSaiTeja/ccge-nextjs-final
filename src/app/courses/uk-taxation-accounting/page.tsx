...
export const metadata: Metadata = {
  title: "UK Taxation & Accounting - CCGE | Corporate Commerce Global Education",
  description: "Master UK Taxation & Accounting with CCGE's comprehensive program"
};

export default function UKTaxationAccountingPage() {
  const course = ccge_courses.find((item) => item.id === 11);
